...
public class BlogAdminController {
	...
	private BlogIndex blogIndex = new BlogIndex(); // lucene索引
	...
	public String list(@RequestParam(value = "page", required = false) String page,
		...
		map.put("title", StringUtil.formatLike(blog.getTitle())); // 模糊查询，利用工具类处理标题
		...
		// 封装到json
		JSONObject result = new JSONObject();
		JsonConfig config = new JsonConfig(); // 日期处理
